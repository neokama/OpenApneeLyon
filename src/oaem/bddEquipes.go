...
func (base Bdd) checkTeam() {
	...
	for base.resultat.Next() {
		if info[0] == "SOLO" {
			...
			var res string
			var res2 string
			var nbSexeHomme string
			var nbSexeFemme string
			...
			nbSexeHomme, nbSexeFemme = base.countSexeComp(6, info[0])
			...
			file.WriteString(info[0] + "|" + nbComp + "|" + "Homme : " + nbSexeHomme + "|" + "Femme : " + nbSexeFemme + "|" + res + "|" + res2 + "\r\n")
			file2.WriteString(info[0] + "|" + nbComp + "|" + "Homme : " + nbSexeHomme + "|" + "Femme : " + nbSexeFemme + "|" + res + "|" + res2 + "\r\n")
			...
			if nbSexeHomme != "3" {
				file.WriteString("Erreur nombre d'homme dans l'equipe " + info[0] + " où il y a " + nbSexeHomme + " hommes !\r\n")
				file2.WriteString("Erreur nombre d'homme dans l'equipe " + info[0] + " où il y a " + nbSexeHomme + " hommes !\r\n")
				etat4 = false
			} else {
				etat4 = true
			}
			...
			if nbSexeFemme != "2" {
				file.WriteString("Erreur nombre de femme dans l'equipe " + info[0] + " où il y a " + nbSexeFemme + " femmes !\r\n")
				file2.WriteString("Erreur nombre de femme dans l'equipe " + info[0] + " où il y a " + nbSexeFemme + " femmes !\r\n")
				etat5 = false
			} else {
				etat5 = true
...
func (base Bdd) verif(val string, num int) {
	...
	if num == 1 {
		...
		idCol, value = idCol2name(5, value)
	}
	base.resultat, base.err = base.db.Query(fmt.Sprint("SELECT COUNT(*) FROM competiteurs WHERE ", idCol, " = ", value))
	if base.err != nil {
